        ...
        return (
            <div>
                <div style={{display:'flex', alignItems:'center', marginBottom:20}}>
                    <Checkbox sx={{color: '#c52a25', '&.Mui-checked': {color: '#c52a25'}}} onChange={()=>this.setState({showUserDetailsForm: !this.state.showUserDetailsForm})}  checked={this.state.showUserDetailsForm}/>
                    <span>
                ...
                <ReactToPrint
                    ...
                    trigger={() => <Button
                       ...
                       size="large" variant="contained" startIcon={<FileDownloadIcon/>}>
                  ...
                  >
                    ...
                    <DialogContent dividers={true}>
                      <DialogContentText
                        ...
                        tabIndex={-1}
                      >
                          At ChestXpert, accessible from chestxpert.live, one of our main priorities is the privacy of our visitors.
                          This Privacy Policy document contains types of information that is collected and recorded by ChestXpert and how we use it.
                          If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.
                          This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in ChestXpert.
                          This policy is not applicable to any information collected offline or via channels other than this website.
                            ...
                            <br/><br/>
                            ChestXpert follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics.
                            ...
                            <br/><br/>
                            ChestXpert's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information.
