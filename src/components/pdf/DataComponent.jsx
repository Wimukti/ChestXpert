      ...
      <div className="pdfDownloader">
        ...
        <div className="content">
          ...
          {this.props.showUserDetails && (
            <>
              <div>
                <Typography sx={{ fontSize: 'calc(1.3rem + .6vw)', fontWeight: 600 }}>Patient Details:</Typography>
                <div>
                  <div>Name: {this.props.patientDetails.name}</div>
                  <div>Age: {this.props.patientDetails.age} years old</div>
                  <div>Sex: {this.props.patientDetails.sex}</div>
                </div>
              </div>
          ...
          <div>
            ...
            <div>
              <img style={{ width: '25%' }} alt="The house from the offer." src={this.props.originalImg} />
            </div>
          </div>
              ...
              <div style={{ marginBottom: 15 }}>
                ...
                <Grid container spacing={5}>
                  <Grid item xs={12} md={6} display={'flex'} flexDirection={'column'} justifyContent={'center'}>
                    ...
                    >
                      <div>
                        {this.props.disease} with{' '}
                        {this.props.approval >= 0
                          ? (this.props.accuracy + this.props.approval) / 2
                          : this.props.accuracy}
                        % accuracy
                      </div>
                    </div>
          ...
          <div>
            <Typography sx={{ fontSize: 'calc(1.3rem + .6vw)', fontWeight: 600 }}>Report Generation:</Typography>
            <div style={{ fontWeight: 'bold', marginTop: 10, padding: '0px 20px' }}>Generated Report:</div>
            <div style={{ padding: '0px 40px', marginTop: 10 }}>{this.props.report}</div>
            <div style={{ fontWeight: 'bold', marginTop: 20, padding: '0px 20px' }}>Radiologist Opinion:</div>
          ...
          <div style={{ marginBottom: 10, fontStyle: 'italic' }}>
            It should be noted that the chestXpert team cannot be held responsible for any errors or inaccuracies in the
