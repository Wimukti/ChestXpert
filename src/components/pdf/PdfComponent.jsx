        ...
        return (
            <div>
                <div style={{display: 'flex', alignItems: 'center', marginBottom: 10}}>
                    <Checkbox sx={{color: '#c52a25', '&.Mui-checked': {color: '#c52a25'}}}
                ...
                {this.state.showUserDetailsForm &&
                    <Box sx={{padding: '0px 0px 10px 0px', width: {xs: '100%', md: 500}}}>
                        <div style={{paddingLeft: 45}}>
                            ...
                            })} value={this.state.patientDetails.name} fullWidth id="name-input" label="Full Name"
                                       variant="outlined" style={{marginBottom: 10}}/>
                            <TextField onChange={(event) => this.setState({
                                patientDetails: {
                                    ...this.state.patientDetails,
                                    age: event.target.value
                                }
                            })} value={this.state.patientDetails.age} fullWidth id="age-input" label="Age"
                                       variant="outlined" type='number' style={{marginBottom: 10}}/>
                            <Select
                        ...
                        <div style={{display: 'flex', alignItems: 'center'}}>
                            ...
                            <span>
                            I agree to <span style={{cursor: 'pointer', color: '#c52a25'}}
                                             onClick={() => this.setState({open: true})}> Privacy Policy </span>
                        </span>
                        </div>
                    </Box>
                }
                    ...
                    >
                        ...
                        <DialogContent dividers={true}>
                            <DialogContentText
                                ...
                                tabIndex={-1}
                            >
                                At ChestXpert, accessible from chestxpert.live, one of our main priorities is the
                                privacy of our visitors.
                                This Privacy Policy document contains types of information that is collected and
                                recorded by ChestXpert and how we use it.
                                ...
                                <br/><br/>
                                ChestXpert follows a standard procedure of using log files. These files log visitors
                                ...
                                <br/><br/>
                                ChestXpert's Privacy Policy does not apply to other advertisers or websites. Thus, we
